...
/*		out of admin and onto homepage	   */
/*******************************************/

function redirectSubsToFrontend() {
	// code redirects subscriber users to front end without having them view the admin dashboard in wp
...
function noSubsAdminBar() {
	// code hides the admin bar if the user role is set to subscriber
	$ourCurrentUser = wp_get_current_user();
