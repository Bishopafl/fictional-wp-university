...
class Search {
	...
	getResults() {
		$.getJSON(universityData.root_url + '/wp-json/university/v1/search?term=' + this.searchField.val(), (results) => { // es6 arrow function
			// backticks create template literal to drop down and write html. javascript is writting in template literals using ${}
			this.resultsDiv.html(` 
				<div class="row">
					<div class="one-third">
